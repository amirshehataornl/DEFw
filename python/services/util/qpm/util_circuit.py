...
class Circuit:
	...
	def setup_circuit_run_details(self, max_qubits):
		...
		try:
			...
			# self.info['mapping'] = 'ppr:1:l3cache:pe=7'
			# self.info['mapping'] = 'ppr:1:l3cache'
			# self.info['mapping'] = 'l3cache:pe=7'
			self.info['mapping'] = 'core'
			# self.info['mapping'] = 'core:pe=8'
			# self.info['mapping'] = 'socket'
			# self.info['mapping'] = 'numa:pe=8:overload-allowed'
			# pass
